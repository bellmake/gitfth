...
public class PropertiesEditor extends MultiPageEditorPart
{
   ...
   private void initTreeEditors() {
	   final String VALUE_COLUMN_ID = "Value";
	   final String KEY_COLUMN_ID = "Key";
	   
	   treeViewer.setColumnProperties(new String[] { KEY_COLUMN_ID, VALUE_COLUMN_ID });
	   
	   final TextCellEditor keyEditor = new TextCellEditor(treeViewer.getTree());
	   final TextCellEditor valueEditor = new TextCellEditor(treeViewer.getTree());
	   treeViewer.setCellEditors(new CellEditor[] { keyEditor, valueEditor });
	   treeViewer.setCellModifier(new PropertiesEditorCellModifier(this, treeViewer));
